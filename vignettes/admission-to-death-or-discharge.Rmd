...
```{r}
survSurfcsv = out %>% createSurvivalSurfaces(timepoints = 0:30)
write.csv(
...
plotProbabilityMatrix(survSurfcsv,"gamma",pExpr=1-cdf) %>% saveThirdPageFigure("~/Dropbox/covid19/ventilator-demand/parameterisation/admission-to-discharge/daily_probability_by_age")
