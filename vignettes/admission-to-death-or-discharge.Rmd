...
CHESSClean = CHESS %>% chessAdmissionSubset("2020-04-15")
```
...
plotProbabilityMatrix(survSurfcsv,"gamma") %>% saveThirdPageFigure("~/Dropbox/covid19/ventilator-demand/parameterisation/admission-to-discharge/daily_probability_by_age")
