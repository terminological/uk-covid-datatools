...
any symptoms & vulnerable people [@publichealthenglandCOVID19GuidanceSocial2020],
...
This section covers the following aspects of the methodology employed
...
currentRt$rtAssumed = currentRt$rtAssumed  %>% mutate(per1M = sprintf("%1.1f",Est.value/population*1000000))
r0UK = currentRt$rtAssumed %>% filter(codeType=="UK")
...
Estimates of the $R_t$ in the different countries of the UK, based on cases, deaths, hospital admissions or triage calls is presented in table 3 and figure 2. 
