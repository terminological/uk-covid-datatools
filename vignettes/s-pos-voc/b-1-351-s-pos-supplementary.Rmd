...
p1 %>% standardPrintOutput::saveFullPageFigure("~/Dropbox/covid19/sa-variant/RegionalMap")
```
...
# 
# mapping %>% readr::write_csv("~/Dropbox/covid19/sa-variant/LSOA2AOC.csv")
# 
# mapping = readr::read_csv("~/Dropbox/covid19/sa-variant/LSOA2AOC.csv")
