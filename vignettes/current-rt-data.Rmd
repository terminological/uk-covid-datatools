...
```{r}
p = tsp$plotIncidenceQuantiles(currentRt$rt, denominatorExpr = population/1000000, events = events, dates="2020-07-01", colour=statistic, ylim=c(0,1500))+
...
p2 = tsp$plotRt(
    ...
    events = events,dates = "2020-10-01", 
    colour=statistic, 
    rtlim = c(0.75,1.25), ribbons=TRUE)+
  facet_wrap(vars(name),ncol=4)+
  theme(legend.position = "bottom")
p2 %>% 
