...
with(currentRt$source, {
  p = tsp$plotIncidenceQuantiles(triageCTRY, denominatorExpr = population/1000000, events = events, colour=subgroup, dates="2020-07-01")+
...
```{r}
with(currentRt$source, {
  p=tsp$plotIncidenceQuantiles(finalTriageCTRY, denominatorExpr = population/1000000, events = events, dates="2020-07-01")+facet_wrap(vars(name))+scale_y_continuous(trans="log1p", breaks = c(0,5,15,50,150))+ylab("per 1M per day")
...
```{r}
with(currentRt$source, {
  p=tsp$plotIncidenceQuantiles(casesCTRY, denominatorExpr = population/1000000, events = events, dates="2020-07-01", colour = source)+facet_wrap(vars(name))+scale_y_continuous(trans="log1p", breaks = c(0,5,15,50,150,500))+ylab("per 1M per day")
...
```{r}
with(currentRt$source, {
  p=tsp$plotIncidenceQuantiles(finalCasesCTRY, denominatorExpr = population/1000000, events = events, dates="2020-07-01")+facet_wrap(vars(name))+scale_y_continuous(trans="log1p", breaks = c(0,5,15,50,150,500))+ylab("per 1M per day")
...
```{r}
with(currentRt$source, {
  p=tsp$plotIncidenceRollmean(admissionsCTRY, denominatorExpr = population/1000000, colour=source, events = events, dates="2020-07-01") +
    facet_wrap(vars(name))+
...
```{r}
with(currentRt$source, {
  p=tsp$plotIncidenceQuantiles(finalAdmissionsCTRY, denominatorExpr = population/1000000, events = events, dates="2020-07-01") +facet_wrap(vars(name))+scale_y_continuous(trans="log1p", breaks = c(0,2,5,10,20))+ylab("per 1M per day")
...
```{r}
with(currentRt$source, {
  p=tsp$plotIncidenceRollmean(deathsCTRY, denominatorExpr = population/1000000, events = events, dates="2020-07-01", colour=source) +facet_wrap(vars(name))+scale_y_continuous(trans="log1p", breaks = c(0,2,5,10,20))+ylab("per 1M per day")
...
```{r}
with(currentRt$source, {
  p = tsp$plotIncidenceQuantiles(finalDeathsCTRY, denominatorExpr = population/1000000, events = events, dates="2020-07-01") +facet_wrap(vars(name))+scale_y_continuous(trans="log1p", breaks = c(0,2,5,10,20))+ylab("per 1M per day")
...
```{r}
with(currentRt$source, {
  p = tsp$plotIncidenceQuantiles(casesUK, denominatorExpr = population/1000000, events = events, dates="2020-07-01", colour = source)+scale_y_continuous(trans="log1p", breaks = c(0,5,15,50,150))+ylab("per 1M per day")
...
```{r}
with(currentRt$source, {
  p = tsp$plotIncidenceQuantiles(finalAdmissionsUK, denominatorExpr = population/1000000, events = events, dates="2020-07-01")+scale_y_continuous(trans="log1p", breaks = c(0,2,5,10,20,50))+ylab("per 1M per day")
...
```{r}
with(currentRt$source, {
  p = tsp$plotIncidenceQuantiles(deathsUK, denominatorExpr = population/1000000, events = events, dates="2020-07-01", colour = source)+scale_y_continuous(trans="log1p", breaks = c(0,2,5,10,20))+ylab("per 1M per day")
...
- TODO: Disabled as problems with data

<!-- ```{r} -->
<!-- with(currentRt$source, { -->
<!--   p = tsp$plotIncidenceRollmean(triageNHSER, denominatorExpr = population/1000000, events = events, dates="2020-07-01", colour=subgroup)+ -->
<!--     facet_wrap(vars(name))+ -->
<!--     scale_y_continuous(trans="log1p", breaks = c(0,5,15,50,150))+ylab("per 1M per day") -->
...
<!-- ```{r} -->
<!-- with(currentRt$source, { -->
<!--   p = tsp$plotIncidenceQuantiles(finalTriageNHSER, denominatorExpr = population/1000000, events = events, dates="2020-07-01")+ -->
<!--     facet_wrap(vars(name))+ -->
...
```{r}
with(currentRt$source, {
  p = tsp$plotIncidenceRollmean(casesNHSER, denominatorExpr = population/1000000, events = events, dates="2020-07-01", colour=subgroup)+
    facet_wrap(vars(name))+
    scale_y_continuous(trans="log1p", breaks = c(0,5,15,50,150))+
    ylab("per 1M per day")
...
```{r}
with(currentRt$source, {
  p=tsp$plotIncidenceQuantiles(finalCasesNHSER, denominatorExpr = population/1000000, dates="2020-07-01", events = events)+
    facet_wrap(vars(name))+
    scale_y_continuous(trans="log1p", breaks = c(0,5,15,50,150))+
    ylab("per 1M per day")
...
```{r}
with(currentRt$source, {
  p = tsp$plotIncidenceRollmean(admissionsNHSER, denominatorExpr = population/1000000, colour=source, events = events, dates="2020-07-01")+
    facet_wrap(vars(name))+
    scale_y_continuous(trans="log1p", breaks = c(0,5,15,50,150))+
    ylab("per 1M per day")
...
```{r}
with(currentRt$source, {
  p = tsp$plotIncidenceQuantiles(finalAdmissionsNHSER, denominatorExpr = population/1000000, events = events, dates="2020-07-01")+
    facet_wrap(vars(name))+
    scale_y_continuous(trans="log1p",breaks=c(0,5,15,50,150))+
    ylab("per 1M per day")
...
```{r}
with(currentRt$source, {
  p = tsp$plotIncidenceQuantiles(finalIcuAdmissionsNHSER, denominatorExpr = population/1000000, events = events, dates="2020-07-01")+
    facet_wrap(vars(name))+
...
```{r}
with(currentRt$source, {
  p = tsp$plotIncidenceQuantiles(deathsNHSER, denominatorExpr = population/1000000, events = events, dates="2020-07-01", colour=subgroup)+
    facet_wrap(vars(name))+
...
```{r}
with(currentRt$source, {
  p = tsp$plotIncidenceQuantiles(finalDeathsNHSER, denominatorExpr = population/1000000, events = events, dates="2020-07-01")+facet_wrap(vars(name))+scale_y_continuous(trans="log1p", breaks = c(0,5,15,50,150))+ylab("per 1M per day")
...
```{r}
p = tsp$plotIncidenceQuantiles(currentRt$rt7, denominatorExpr = population/1000000, events = events, dates="2020-07-01", colour=statistic, ylim=c(0,1500))+
...
p2 = tsp$plotRt(
    ...
    events = events,dates = "2020-07-01", 
    colour=statistic, 
    rtlim = c(0.5,1.75), ribbons=TRUE)+
  facet_wrap(vars(name),ncol=4)+
  theme(legend.position = "bottom")
...
p2 = tsp$plotRt(
    ...
    events = events,dates = "2020-07-01", 
    colour=statistic, 
    rtlim = c(0.75,1.75), ribbons=TRUE)+
  facet_wrap(vars(name),ncol=4)+
  theme(legend.position = "bottom")
p2 %>% 
