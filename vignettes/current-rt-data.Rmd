...
```{r}
with(currentRt$source, {
  p=tsp$plotIncidenceQuantiles(finalCasesCTRY, denominatorExpr = population/1000000, events = events, dates=startDate)+facet_wrap(vars(name))+scale_y_continuous(trans="log1p", breaks = c(0,5,15,50,150,500))+ylab("per 1M per day")
...
```{r}
with(currentRt$source, {
  p=tsp$plotIncidenceQuantiles(finalAdmissionsCTRY, denominatorExpr = population/1000000, events = events, dates=startDate) +facet_wrap(vars(name))+scale_y_continuous(trans="log1p", breaks = c(0,2,5,10,20))+ylab("per 1M per day")
...
```{r}
with(currentRt$source, {
  p = tsp$plotIncidenceQuantiles(finalDeathsCTRY, denominatorExpr = population/1000000, events = events, dates=startDate) +facet_wrap(vars(name))+scale_y_continuous(trans="log1p", breaks = c(0,2,5,10,20))+ylab("per 1M per day")
...
```{r}
with(currentRt$source, {
  p = tsp$plotIncidenceQuantiles(finalAdmissionsUK, denominatorExpr = population/1000000, events = events, dates=startDate)+scale_y_continuous(trans="log1p", breaks = c(0,2,5,10,20,50))+ylab("per 1M per day")
...
```{r}
with(currentRt$source, {
  p = tsp$plotIncidenceQuantiles(deathsUK, denominatorExpr = population/1000000, events = events, dates=startDate, colour = source)+scale_y_continuous(trans="log1p", breaks = c(0,2,5,10,20))+ylab("per 1M per day")
...
```{r}
with(currentRt$source, {
  p = tsp$plotIncidenceRollmean(triageNHSER, denominatorExpr = population/1000000, events = events, dates=startDate, colour=subgroup)+
    facet_wrap(vars(name))+
    scale_y_continuous(trans="log1p", breaks = c(0,5,15,50,150))+ylab("per 1M per day")
...
```{r}
with(currentRt$source, {
  p = tsp$plotIncidenceRollmean(casesNHSER, denominatorExpr = population/1000000, events = events, dates=startDate, colour=subgroup)+
    facet_wrap(vars(name))+
    scale_y_continuous(trans="log1p", breaks = c(0,5,15,50,150))+
    ylab("per 1M per day")
...
```{r}
with(currentRt$source, {
  p = tsp$plotIncidenceRollmean(admissionsNHSER, denominatorExpr = population/1000000, colour=source, events = events, dates=startDate)+
    facet_wrap(vars(name))+
    scale_y_continuous(trans="log1p", breaks = c(0,5,15,50,150))+
    ylab("per 1M per day")
...
p2 = tsp$plotRt(
  ...
  theme(legend.position = "bottom")
p2 %>% 
  standardPrintOutput::saveThirdPageFigure("~/Dropbox/covid19/current-rt/data/Fig22_Rt7_AllGeogsAllModels")
