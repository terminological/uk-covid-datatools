...
p = tmp %>% tsp$plotIncidenceQuantiles(denominatorExpr = population/1000000,colour=name, events = events,dates = "2020-07-01") + facet_wrap(vars(ageCat), ncol=3) + 
...
p = tmp %>% tsp$plotIncidenceQuantiles(denominatorExpr = population/1000000,colour=name, events = events,dates = "2020-07-01") + facet_wrap(vars(ageCat)) + 
...
```{r}
tmp = icuAdmissions %>% filter(codeType == "NHSER") %>% mutate(ageCat = tsp$ageCatToFactor(ageCat,c("<1","1-4","5-14","15-24","25-44","45-54","55-64","65-74","75-84",">85"))) %>% tsp$aggregateSubgroup() %>% tsp$aggregateGender() %>% tsp$aggregateSource() %>% dpc$demog$findDemographics() 
p = tmp %>% tsp$plotIncidenceQuantiles(denominatorExpr = population/1000000,colour=ageCat, events = events,dates = "2020-07-01") + facet_wrap(vars(name)) + 
