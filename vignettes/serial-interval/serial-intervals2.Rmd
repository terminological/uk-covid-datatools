...
si1$getBasicConfig(quick = FALSE)$si_sample %>% write.table("~/Git/uk-covid-datatools/vignettes/serial-interval/resampled-truncated-empirical-si-sample.csv")
```
...
tmp %>% write.table("~/Git/uk-covid-datatools/vignettes/serial-interval/generation-interval-fitted-si-sample.csv")
```
